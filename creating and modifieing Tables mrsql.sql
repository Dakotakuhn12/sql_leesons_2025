...
-- Each row is a recprd - contains information about a single object (eg. one employee)
-- Each column is a type of data (eg. name, data, pay) 
...
create table employees (
    ...
    hourly_pay decimal(5,2), -- the 5 means 5 didgits, the 2 means that 2 are right of the decimal point -999.99 - 999
	hire_date date
);
