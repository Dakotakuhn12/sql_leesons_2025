...
update employees set hourly_pay =10.25, hire_date = "2024-01-07" where first_name = "Sheldon";
...
delete from employees; -- Danger! Danger! All staff will be exterminated if this is run! Danegr!
...
-- Write your SQL here. 
insert into employees values(99, "Pearl", "Krabs", 10.17, curdate());
