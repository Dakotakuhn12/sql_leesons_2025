...
-- Error Code: 1452. Cannot add or update a child row: a foreign key constraint fails (`cmp_dakuhn`.`transactions`, CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`))